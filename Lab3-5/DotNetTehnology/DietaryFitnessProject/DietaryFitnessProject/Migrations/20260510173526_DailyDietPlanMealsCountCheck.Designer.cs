...
namespace DietaryFitnessProject.Migrations
{
    ...
    [Migration("20260510173526_DailyDietPlanMealsCountCheck")]
    partial class DailyDietPlanMealsCountCheck
    {
                    ...
                    b.ToTable("DailyDietPlan", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_DailyDietPlan_NumberOfMeals_Range", "[DailyPlanNumberOfMeals] >= 1 AND [DailyPlanNumberOfMeals] <= 5");
            ...
            modelBuilder.Entity("DietaryFitnessProject.DAL.Entities.User", b =>
                {
                    ...
                    b.ToTable("User", null, t =>
                        {
                            t.HasCheckConstraint("CK_User_Age_Range", "[Age] >= 10 AND [Age] <= 120");
